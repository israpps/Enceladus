...
local CUBE = Render.loadOBJ("mesh/QBO.obj", orangetex)
...
function DealWith3D()
  ...
  Render.drawOBJ(CUBE,  savedrx, savedry, modelz, savedly, savedlx, 0.0)
  Render.drawOBJ(CUBE,  savedrx-5, savedry+1, modelz, savedly, -savedlx, 0.0)
