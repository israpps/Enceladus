	...
	LNG_DESC_CROSS_MODEL  =  "Installs system update for every PS2 of the same region"
	LNG_DESC_CROSS_REGION =  "Installs system update for every PS2 of every region"
	LNG_DESC_PSXDESR      =  "Installs system update for PSX-DESR systems"
